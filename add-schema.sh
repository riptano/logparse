...
SOLRCONFIG_URL="$SCHEME://$HOST:8983/solr/resource/systemlog.log/solrconfig.xml"
...
SCHEMA_URL="$SCHEME://$HOST:8983/solr/resource/systemlog.log/schema.xml"
SCHEMA=schema.xml
...
CREATE_URL="$SCHEME://$HOST:8983/solr/admin/cores?action=CREATE&name=systemlog.log"
